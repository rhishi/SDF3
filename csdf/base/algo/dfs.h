 ...
 *
 * $Id: dfs.h,v 1.1.1.1 2007/10/02 10:59:49 sander Exp $
 *
...
#ifndef CSDF_BASE_ALGO_DFS_H_INCLUDED
#define CSDF_BASE_ALGO_DFS_H_INCLUDED
 ...
 */
void dfs(CSDFgraph *g, v_int &d, v_int &f, CSDFactor **pi,
