...
public:
	...
	SADF_Configuration* getDestination() const { return Destination; };
	CDouble getProbability() const { return Probability; };
	CDouble getTimeSample() const { return TimeSample; };
	
	void setProbability(const CDouble P) { Probability = P; };
