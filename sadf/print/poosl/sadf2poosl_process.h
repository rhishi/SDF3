 ...
 *
 *  Name            :   sadf2poosl_process.h
 *
 *  Author          :   Bart Theelen (B.D.Theelen@tue.nl)
 *
 *  Date            :   13 September 2006
 *
 *  Function        :   Convert SADF Graph into POOSL Model (process class(es))
 *
 *  History         :
...
#ifndef SADF_SADF2POOSL_PROCESS_H_INCLUDED
#define SADF_SADF2POOSL_PROCESS_H_INCLUDED
